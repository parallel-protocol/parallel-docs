...
<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel Governance Token Prl","href":"/developers-hub/parallel-governance-token-prl"},{"label":"Tokenomics","href":"/developers-hub/parallel-governance-token-prl/tokenomics"}]} title={"Key Operations Flows"} />
