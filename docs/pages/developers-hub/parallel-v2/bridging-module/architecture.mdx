...
<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Bridging Module","href":"/developers-hub/parallel-v2/bridging-module"}]} title={"Architecture"} />
