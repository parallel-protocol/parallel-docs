...
description: >-
  The `MIMOEmptyVault` action contracts handle the super vault empty vault logic
  described in [Empty
  Vault](/products/parallel-v2/how-it-works/super-vaults-sv/em…
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Super Vault Sv","href":"/developers-hub/parallel-v2/super-vault-sv"},{"label":"Action Contracts","href":"/developers-hub/parallel-v2/super-vault-sv/action-contracts"}]} title={"MIMOEmptyVault"} />
