...
description: >-
  The `MIMOVaultActions` actions contract is a mirror of the `VaultsCore` owner
  access restricted functionalities. Its sole purpose is to provide a readable
  way…
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Super Vault Sv","href":"/developers-hub/parallel-v2/super-vault-sv"},{"label":"Action Contracts","href":"/developers-hub/parallel-v2/super-vault-sv/action-contracts"}]} title={"MIMOVaultActions"} />
