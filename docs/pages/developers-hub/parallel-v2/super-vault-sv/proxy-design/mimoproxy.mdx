...
title: MIMOProxy
description: >-
  Super Vault utilizes a proxy pattern to enable users to make proxy calls on
  behalf of other users and interact with various contracts (e.g., Parallel core
  prot…
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Super Vault Sv","href":"/developers-hub/parallel-v2/super-vault-sv"},{"label":"Proxy Design","href":"/developers-hub/parallel-v2/super-vault-sv/proxy-design"}]} title={"MIMOProxy"} />
