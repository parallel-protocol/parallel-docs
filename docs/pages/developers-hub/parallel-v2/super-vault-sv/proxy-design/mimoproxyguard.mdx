...
description: >-
  As previously mentioned, the management of MIMOProxy's permissions has been
  delegated to the `MIMOProxyGuard`, which is deployed through the Openzeppelin
  Clone…
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Super Vault Sv","href":"/developers-hub/parallel-v2/super-vault-sv"},{"label":"Proxy Design","href":"/developers-hub/parallel-v2/super-vault-sv/proxy-design"}]} title={"MIMOProxyGuard"} />
