...
<PageHeader breadcrumb={[{"label":"Developers Hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Classic Vaults","href":"/developers-hub/parallel-v2/classic-vaults"}]} title={"VaultsCore"} />
