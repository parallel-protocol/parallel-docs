...
<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V2","href":"/developers-hub/parallel-v2"},{"label":"Classic Vaults","href":"/developers-hub/parallel-v2/classic-vaults"}]} title={"Borrowing and minting PAR/paUSD"} />
