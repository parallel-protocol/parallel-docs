...
<PageHeader breadcrumb={[{"label":"Developers Hub"},{"label":"Parallel V3","href":"/developers-hub/parallel-v3"},{"label":"Onchain Tools","href":"/developers-hub/parallel-v3/onchain-tools"},{"label":"Oracles","href":"/developers-hub/parallel-v3/onchain-tools/oracles"},{"label":"RedStone","href":"/developers-hub/parallel-v3/onchain-tools/oracles/redstone"}]} title={"Fundamental"} subtitle={"More details on Fundamental RedStone Oracles"} />
