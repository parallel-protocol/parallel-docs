...
<PageHeader breadcrumb={[{"label":"Developers Hub"},{"label":"Parallel V3","href":"/developers-hub/parallel-v3"},{"label":"Onchain Tools","href":"/developers-hub/parallel-v3/onchain-tools"},{"label":"Oracles","href":"/developers-hub/parallel-v3/onchain-tools/oracles"},{"label":"Dia","href":"/developers-hub/parallel-v3/onchain-tools/oracles/dia"}]} title={"Fundamental"} subtitle={"More details on Fundamental DIA Oracles"} />
