...
<PageHeader breadcrumb={[{"label":"Developers Hub"},{"label":"Parallel V3","href":"/developers-hub/parallel-v3"},{"label":"Build On Parallel","href":"/developers-hub/parallel-v3/build-on-parallel"}]} title={"Parallelizer Module Integration"} subtitle={"Interact with the Parallelizer Module to mint, burn or redeem Parallel stablecoins"} />
