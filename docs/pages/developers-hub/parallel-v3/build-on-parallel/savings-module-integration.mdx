...
<PageHeader breadcrumb={[{"label":"Developers Hub","href":"/developers-hub"},{"label":"Parallel V3","href":"/developers-hub/parallel-v3"},{"label":"Build On Parallel","href":"/developers-hub/parallel-v3/build-on-parallel"}]} title={"Savings Module Integration"} subtitle={"Integrate Parallel Savings Module to earn from your stablecoins"} />
