...
<PageHeader breadcrumb={[{"label":"Security"}]} title={"Parallel Emergency Guardians"} subtitle={"Multisig signers can take charge of emergency intervention on every chains where Parallel is deployed"} />
