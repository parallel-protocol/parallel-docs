...
<PageHeader breadcrumb={[{"label":"Security","href":"/security"}]} title={"Proof of Solvency"} subtitle={"Parallel V3 Proof of Solvency"} />
...
[Parallel | Proof of Solvency Dashboard]([https://app.parallel.best/transparency](https://app.parallel.best/transparency))
  </Tab>
</Tabs>
