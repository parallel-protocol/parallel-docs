...
<PageHeader breadcrumb={[{"label":"Security","href":"/security"}]} title={"Audits"} subtitle={"A breakdown of security reviews covering deployed smart contracts of Parallel"} />
