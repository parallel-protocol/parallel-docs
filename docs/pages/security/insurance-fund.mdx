...
description: Detailing the coverage and strategy of the Parallel Insurance Fund
subtitle: Detailing the coverage and strategy of the Parallel Insurance Fund
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Security","href":"/security"}]} title={"Insurance Fund"} subtitle={"Detailing the coverage and strategy of the Parallel Insurance Fund"} />
