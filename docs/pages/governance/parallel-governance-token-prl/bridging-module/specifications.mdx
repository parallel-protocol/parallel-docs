...
<PageHeader breadcrumb={[{"label":"Governance","href":"/governance"},{"label":"Parallel Governance Token Prl","href":"/governance/parallel-governance-token-prl"},{"label":"Bridging Module","href":"/governance/parallel-governance-token-prl/bridging-module"}]} title={"Specifications"} subtitle={"PRL Bridging Module Specifications"} />
