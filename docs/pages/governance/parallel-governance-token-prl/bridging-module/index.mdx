...
<PageHeader breadcrumb={[{"label":"Governance"},{"label":"Parallel Governance Token Prl","href":"/governance/parallel-governance-token-prl"}]} title={"Bridging Module"} subtitle={"Explaining the PRL Bridging Module"} />
