...
description: >-
  PRL holders have the option to stake their tokens in 2 different forms: sPRL1,
  single PRL staking; and sPRL2, PRL/wETH 80/20 BPT staking. Each option allows
  ho…
subtitle: Understanding Staking Mechanisms
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Governance","href":"/governance"},{"label":"Parallel Governance Token Prl","href":"/governance/parallel-governance-token-prl"},{"label":"Tokenomics","href":"/governance/parallel-governance-token-prl/tokenomics"}]} title={"Staking Mechanisms"} subtitle={"Understanding Staking Mechanisms"} />
