...
<PageHeader breadcrumb={[{"label":"Governance"},{"label":"Parallel Governance Token Prl","href":"/governance/parallel-governance-token-prl"},{"label":"Tokenomics","href":"/governance/parallel-governance-token-prl/tokenomics"}]} title={"Staking Mechanisms"} subtitle={"Understanding Staking Mechanisms"} />
