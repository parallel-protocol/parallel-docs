...
<PageHeader breadcrumb={[{"label":"Governance","href":"/governance"},{"label":"Parallel Governance Token Prl","href":"/governance/parallel-governance-token-prl"},{"label":"Tokenomics","href":"/governance/parallel-governance-token-prl/tokenomics"}]} title={"ParaBoost"} subtitle={"Understanding ParaBoost"} />
