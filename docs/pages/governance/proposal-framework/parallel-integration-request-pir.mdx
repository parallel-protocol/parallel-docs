...
<PageHeader breadcrumb={[{"label":"Governance"},{"label":"Proposal Framework","href":"/governance/proposal-framework"}]} title={"Parallel Integration Request (PIR)"} subtitle={"Explaining Parallel Integration Request"} />
