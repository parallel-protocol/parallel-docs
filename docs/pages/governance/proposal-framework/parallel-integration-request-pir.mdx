...
description: Explaining Parallel Integration Request
subtitle: Explaining Parallel Integration Request
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Governance","href":"/governance"},{"label":"Proposal Framework","href":"/governance/proposal-framework"}]} title={"Parallel Integration Request (PIR)"} subtitle={"Explaining Parallel Integration Request"} />
