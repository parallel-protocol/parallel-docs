...
description: Understanding how to participate in the DAO.
subtitle: Understanding how to participate in the DAO.
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Governance","href":"/governance"}]} title={"sPRL and Voting Power"} subtitle={"Understanding how to participate in the DAO."} />
