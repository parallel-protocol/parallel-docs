...
<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V2","href":"/products/parallel-v2"},{"label":"How It Works","href":"/products/parallel-v2/how-it-works"}]} title={"Bridging Module"} />
...
The Bridging Module codebase is publicly available [here](broken://pages/-mdojpqd4z_gn5a5ule_) and is released under the MIT License. The code has been audited by Bail Security. The audit report is available [here](/security/audits).
