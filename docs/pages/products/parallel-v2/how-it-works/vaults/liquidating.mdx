...
title: Liquidating
description: >-
  Liquidation ensures that there is always sufficient collateral to cover all
  PAR/paUSD tokens. Vaults below a specified health factor are subject to
  liquidation…
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V2","href":"/products/parallel-v2"},{"label":"How It Works","href":"/products/parallel-v2/how-it-works"},{"label":"Vaults","href":"/products/parallel-v2/how-it-works/vaults"}]} title={"Liquidating"} />
