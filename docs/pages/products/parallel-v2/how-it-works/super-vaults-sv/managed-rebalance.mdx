...
description: >-
  The automated vault system is designed to provide users with confidence in
  each automated rebalance, ensuring that rebalances are done in a sensible
  manner and…
---
import { PageHeader } from '@/components/PageHeader'

<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V2","href":"/products/parallel-v2"},{"label":"How It Works","href":"/products/parallel-v2/how-it-works"},{"label":"Super Vaults Sv","href":"/products/parallel-v2/how-it-works/super-vaults-sv"}]} title={"Managed Rebalance"} />
