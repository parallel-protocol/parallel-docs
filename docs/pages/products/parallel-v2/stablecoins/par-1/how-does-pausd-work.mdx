...
<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V2","href":"/products/parallel-v2"},{"label":"Stablecoins","href":"/products/parallel-v2/stablecoins"},{"label":"Par 1","href":"/products/parallel-v2/stablecoins/par-1"}]} title={"How does paUSD work?"} />
...
:::info
To get more informations on each collateral risks parameters, you can read [paUSD Risk Parameters](broken://pages/rqx6kqeym5jrdmwd0mj2).
:::
