...
<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V2","href":"/products/parallel-v2"},{"label":"Stablecoins","href":"/products/parallel-v2/stablecoins"},{"label":"Par","href":"/products/parallel-v2/stablecoins/par"}]} title={"How does PAR work?"} />
...
:::info
To get more informations on each collateral risks parameters, you can read [PAR Risk Parameters](broken://pages/ysvt5xpjysnrx9sbkbvw).
:::
