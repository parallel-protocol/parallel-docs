...
<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V2","href":"/products/parallel-v2"},{"label":"Stablecoins","href":"/products/parallel-v2/stablecoins"}]} title={"PAR"} />
...
:::info
You can use PAR to earn yield by [Providing Liquidity](broken://pages/yce5dnorl2fgcyqkfxtg).
:::
