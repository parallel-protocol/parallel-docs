...
<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V3","href":"/products/parallel-v3"}]} title={"Governance"} subtitle={"Detailing where Governance is involved"} />
