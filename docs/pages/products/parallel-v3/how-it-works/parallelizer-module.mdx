...
<PageHeader breadcrumb={[{"label":"Products"},{"label":"Parallel V3","href":"/products/parallel-v3"},{"label":"How It Works","href":"/products/parallel-v3/how-it-works"}]} title={"Parallelizer Module"} subtitle={"Explaining the Parallelizer Module"} />
