...
<PageHeader breadcrumb={[{"label":"Products","href":"/products"},{"label":"Parallel V3","href":"/products/parallel-v3"},{"label":"How It Works","href":"/products/parallel-v3/how-it-works"}]} title={"Bridging Module"} subtitle={"Explaining the Bridging Module"} />
