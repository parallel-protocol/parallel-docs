      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            link: "/agents/mcp",
            items: [
              { text: "Tools reference", link: "/agents/mcp/tools" },
              { text: "How transactions work", link: "/agents/mcp/transactions" },
            ],
          },
          {
            text: "CLI",
            link: "/agents/cli",
            items: [{ text: "Command reference", link: "/agents/cli/commands" }],
          },
          {
            text: "Recipes",
            items: [
