---
title: PRL Bridging Module — Governance
description: >-
  The PRL bridging module moves PRL between supported chains over LayerZero,
  using configurable Decentralized Verifier Networks and an X of Y of N security
  model.
