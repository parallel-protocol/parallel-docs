---
title: PRL Bridging Module Specifications — Governance
description: >-
  How PRL bridges between chains: LayerZero's OFT standard, and the modular
  security stack of DVNs the DAO configures around each route.
...
To make the protocol more secure in case of a problem, we've added the possibility to pause the PRL ‘burn’ function. This function can be called by[ emergency guardians](/security/parallel-emergency-guardians) as well as by the DAO via a vote. The ‘burn’ function can be deactivated and reactivated via the 'pause' and 'unpause' functions.
