---
title: Parallel Governance Token (PRL) — Governance
description: >-
  PRL is the governance token of the Parallel Protocol: an ERC-20 issued on
  Ethereum with a fixed one billion supply and no mint, pause or admin function.
