...
title: Overview
description: >-
  Public documentation of Parallel, a decentralized stablecoin protocol: USDp
  and sUSDp, the PRL governance token, the modules and the agent tooling.
subtitle: Introducing Parallel
---
<img src="/hero-1125.webp" srcSet="/hero-750.webp 750w, /hero-1125.webp 1125w, /hero.webp 1500w" sizes="(min-width: 1080px) 672px, 100vw" width="1500" height="400" alt="Enter the Parallel World" style={{width: '100%', height: 'auto', borderRadius: 12, marginBottom: '1.5rem'}} />
