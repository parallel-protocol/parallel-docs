...
| Fees | Mint fee currently 0.00% on every accepted asset; burn fee currently 0.00% on base stables and 0.10% on yield-bearing assets; bridging 0.00% protocol fee plus LayerZero gas. Fees are adaptive DAO parameters. See [Fees](/products/parallel-v3/fees) |
