...
| Ethereum | sfrxUSD | 0.00% | 0.10% | 95.00% |
| Ethereum | USDe | 0.00% | 0.00% | 100.00% |
| Ethereum | sUSDe | 0.00% | 0.10% | 95.00% |
| Base | USDS | 0.00% | 0.00% | 100.00% |
| Base | sUSDS | 0.00% | 0.10% | 95.00% |
| HyperEVM | USDe | 0.00% | 0.00% | 100.00% |
| HyperEVM | sUSDe | 0.00% | 0.10% | 95.00% |
| Avalanche | USDC | 0.00% | 0.00% | 100.00% |
| Avalanche | ygamiUSDC (Silo vault, wrapped as a Yearn vault) | 0.00% | 0.10% | 95.00% |
...
- **Burn fee: 0.00%** on base stablecoins (frxUSD, USDe, USDS, USDC) and **0.10%** on yield-bearing assets (sfrxUSD, sUSDe, sUSDS, ygamiUSDC).
