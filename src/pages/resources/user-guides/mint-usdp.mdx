...
- A wallet that supports the chain you want to mint on (MetaMask, Rabby, a Safe, or any WalletConnect wallet).
...
:::tip
The app can route through aggregators to fill a swap. Turn on **Mint Preferred** if you want the trade to go through the Parallelizer contracts only, so you always mint natively at oracle price rather than buying USDp on a DEX.
:::
