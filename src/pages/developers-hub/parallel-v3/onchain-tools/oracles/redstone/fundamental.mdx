---
title: RedStone Oracles — Fundamental
description: RedStone fundamental price feeds for Parallel, with the gas wallets that keep them pushing data on chain and the addresses to monitor their funding.
