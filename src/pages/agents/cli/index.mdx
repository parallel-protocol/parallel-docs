...
description: The Parallel CLI queries live protocol data, builds and signs transactions, and makes x402 payments from the terminal or any script. One npm install, no config, wallet strictly opt-in.
---
