...
description: Configuration, framework adapters, and the facilitator client for the Parallel x402 SDK — paymentMiddleware, withPayment, FacilitatorClient, and createPaymentGate.
---
