...
description: The Parallel MCP server gives Claude, Cursor and any MCP client live protocol data and ready-to-sign transactions. No config, no API key, no private key.
---
