...
title: USDp & sUSDp
description: >-
  USDp is Parallel V3's decentralized, over-collateralized USD stablecoin, live
  on 24 chains. sUSDp is its yield-bearing ERC-4626 version. Addresses for both.
---
...
For a one-page summary of key facts, contracts and integration links, see the [sUSDp factsheet](/resources/factsheets/susdp).
