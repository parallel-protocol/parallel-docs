---
title: Parallelizer Module — Parallel V3
description: >-
  The Parallelizer Module mints and burns Parallel stablecoins against a
  basket of assets held at target prices, with fees keeping each exposure in
  bounds.
...
- [Fees: minting and burning](/products/parallel-v3/fees#minting-and-burning)
- [Risks: collateral and backing risk](/security/risks#1-collateral-and-backing-risk)
