---
title: Bridging Module — Parallel V3
description: >-
  The Parallel V3 Bridging Module reuses the V2 module unchanged, moving
  stablecoins across chains over LayerZero through DVN verification and its
  Executors.
...
- [Fees: bridging](/products/parallel-v3/fees#bridging)
- [Risks: bridge risk](/security/risks#4-bridge-risk)
- [Bridge USDp guide](/resources/user-guides/bridge)
