---
title: Classic Vaults — Parallel V2
description: >-
  Classic Vaults are the core of Parallel V2: deposit collateral such as ETH,
  then mint PAR or paUSD against it while staying above the collateralization
  ratio.
---
...
* [Fees](/products/parallel-v3/fees#legacy-parallel-v2-fees-par-and-pausd)
