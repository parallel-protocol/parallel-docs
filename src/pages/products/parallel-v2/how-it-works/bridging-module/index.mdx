---
title: Bridging Module — Parallel V2
description: >-
  Tunnel, the Parallel V2 bridging module, moves PAR and paUSD between supported
  chains over LayerZero, with a modular DVN security stack controlled by the
  DAO.
---
