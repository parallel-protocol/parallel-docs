...
Users can deposit from a large variety of collateral types (like wBTC) and borrow a safe amount of PAR at low interest. Every PAR in circulation is over-collateralized by the assets the DAO has approved as collateral.
